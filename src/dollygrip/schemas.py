...
class ExportFrame(BaseModel):
    ...
    settle: float = Field(default=0.7, ge=0, le=10, description="Seconds to wait after moving the playhead before exporting (live: the viewer lags the playhead by one request otherwise)")
